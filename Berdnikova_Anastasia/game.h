...
protected:
    ...
    Game(vector<Base*> &base, Field *&field, log::Adapter *adapter, string &logs) : base(base), field(field){
        rule = new R(2);
...
public:
    static Game<R,2> *getInstance(vector<Base*> &base, Field *&field, log::Adapter *adapter, string &logs) {
...
public:
    static Game<R,3>* getInstance(vector<Base*> &base, Field *&field, log::Adapter *adapter, string &logs) {
