...
public:
	...
	// ќпредел€ет периметр какой фигуры больше
	// ≈сли периметр у текущего объекта >= возвращаем true, иначе - false
...
public:
	...
	// подсчет периметра правильного п€тиугольника
	float perimeter() const override {
...
public:
	...
	// увеличивает/уменьшает рассто€ние между центром фигуры и точкой в k раз
	...
	// масштабирует неправильный п€тиугольник
	void scale(float k) {
