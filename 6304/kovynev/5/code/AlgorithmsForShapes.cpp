...
// ѕроверка двух упор€доченных диапазонов на равенство по определенному критерию
// ”пор€доченные диапазоны по имени
// ѕроверка диапазонов на совпадение имен фигур
...
// ”пор€дочить элементы, пока первые n элементов не будут следовать в требуемом пор€дке.
//  ритерий - увеличение площади фигур
