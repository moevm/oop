...
#include "Logger.h" //4 лаба

//исп. в 7 лабе при исключениях
//проходим по двемерн. массиву движения нашего юнита, обращаемся к доске и нашему юниту
		...
		if (!meta.isEmpty) {
			...
			if (meta.isAttack || meta.isHeal) {
				...
				try {
					...
					Logger::log("ActionDispatcher", e.what());
				}
