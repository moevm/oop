...
#include "Logger.h"
#include <QDebug>
//:PongoBaseBoardUnit от нашего игрока и расширяем векторы для дальнейшего заполнения с помощью  insert
...
//что-то делаем с юнитом ( атакуем), создаем юнит по координатам и смотрим на нашу клетку, если она пустая
...
//для погибающего юнита, для 4 лабы
