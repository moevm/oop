...
private:
	...
	shared_ptr<CellClickBehaviour<Unit>> _clickBehaviour = shared_ptr<CellClickBehaviour<Unit>>(new BaseUnitClickBehaviour());
	shared_ptr<UnitAttackBehaviour> _attackBehaviour = shared_ptr<UnitAttackBehaviour>(new BaseUnitAttackBehaviour());
	shared_ptr<UnitMoveBehaviour> _moveBehaviour = shared_ptr<BaseUnitMoveBehaviour>(new BaseUnitMoveBehaviour());
