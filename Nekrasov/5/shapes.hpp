...
public:
    ...
    Circle( double ix, double iy, double irad ) : Shape(ix, iy), rad( std::abs(irad) ){}
        ...
        virtual void setAngle( double ia )
        {
            angle = ia;
        }
        ...
        virtual void zoom(double inum) { rad *= inum; }

        virtual void setRad( double irad )
        {
            rad = std::abs( irad );
        }
...
public:
    ...
    virtual void makeSimple( unsigned short num, int sideSize, double x, double y )
    {
        arr.clear();
        if( !num )
        {
    ...
    virtual void addDot( double ix, double iy  )
    {
        arr.push_back( {ix, iy} );
    }

    virtual void deleteLastDot()
    {
        arr.pop_back();
    }
};
