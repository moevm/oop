...
public:
    Square(Colour colour,Point p1,Point p2,Point p3,Point p4):Rectangle(colour,p1,p2,p3,p4){
        if(!isSquare())throw "NOT SQUARE!!!";
    }
    Square(Colour colour):Square(colour,Point(0.5,0.5),Point(0.5,-0.5),Point(-0.5,-0.5),Point(-0.5,0.5)){}
