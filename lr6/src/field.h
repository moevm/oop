...
public:
    ...
    void move(Unit* unit, int x, int y, TerminalLog* termLog, FileLog* fileLog, int logFlag, int ruleFlag);
...
class Command{
public:
    virtual void execute(Unit* unit, TerminalLog* termLog, FileLog* fileLog, int logFlag, int ruleFlag) = 0;
protected:
...
public:
    ...
    void execute(Unit* unit, TerminalLog* termLog, FileLog* fileLog, int logFlag, int ruleFlag);
};
