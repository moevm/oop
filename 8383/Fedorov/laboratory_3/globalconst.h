...
const int HUMANCLERIC_VIEW = 4;
const int HUMANGUARD_VIEW  = 5;
const int HUMANTREBUCHET_VIEW  = 6;

const int GRETCHIN_VIEW = 7;
const int TROLSMAGIC_VIEW = 8;
const int GOBLINCATAPULT_VIEW = 9;
const int BASE_VIEW = 10;
...
const int ROCK_CHARACTER = 3;


const int HUMAN_BASE_HP = 100;
const int HUMAN_BASE_LIMIT = 8;
const int HUMAN_BASE_VIEW = 10;

const int CHAOS_BASE_HP = 100;
const int CHAOS_BASE_LIMIT = 8;
const int CHAOS_BASE_VIEW = 10;


const int HEAL_HP = 20;
const int HEALING_CHARACTER = 11;

const int MINE_DAMAGE = 20;
const int MINE_CHARACTER = 12;

const int PORTAL_CHARACTER = 13;

const int ARMOR_NEUTRAL = 10;
const int ARMOR_CHARACTER = 15;
