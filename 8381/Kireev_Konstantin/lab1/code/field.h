...
public:
    ...
    void addObject(unsigned int Nrows, unsigned int Ncols, cellInterface* object); //добавить объект на поле
    ...
    cellInterface* getObject(unsigned int rowNumber, unsigned int columnNumber); //получить указатель на объект
    QString getStringInfo(); //вывод информации о поле
};
