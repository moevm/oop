...
public:
    ...
    virtual GameParameters loadFromFile() = 0;
};
...
public:
    ...
    virtual void setAttackSkills(const Skills &value) = 0;
    virtual void setSecuritySkills(const Skills &value) = 0;
    virtual void setCharacteristics(const Skills &value) = 0;
};
