...
void Unit::setAttackSkills(const Skills &value)
{
attackSkills = value;
}

void Unit::setSecuritySkills(const Skills &value)
{
securitySkills = value;
}

void Unit::setCharacteristics(const Skills &value)
{
