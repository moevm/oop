...
int Interface::St_Game(int u_count){
    ...
    while(1)
    {
        ...
        std::cout << "6.Start New Game" << std::endl;
        //field->show_landscape();
        int choice1 = 0, choice2 = 0, choice3 = 0, flag = 0;
        std::cin >> choice1;
        switch(choice1){
        case 1:
