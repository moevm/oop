...
void Game::createNeutral(NeutralType net, unsigned x, unsigned y)
{
    ...
    switch(net){
    case  VISOR:
        obj = new GetArmor(new Visor());
        break;
    case LAT:
        obj = new GetArmor(new Lat());
        break;
    case BOOTS:
        obj = new GetArmor(new Boots());
        break;
    case ASCORBIC:
        obj = new GetMedicine(new Ascorbic());
        break;
    case   LEONURUS:
        obj = new GetMedicine(new Leonurus());
        break;
    case   BELLADONNA:
        obj = new DrinkPoison(new Belladonna());
        break;
    case CYANIDE:
        obj = new DrinkPoison(new Cyanide());
        break;
    case SWORD:
        obj = new GetWeapon(new Sword());
        break;
    case SICKLE:
        obj = new GetWeapon(new Sickle());
        break;
