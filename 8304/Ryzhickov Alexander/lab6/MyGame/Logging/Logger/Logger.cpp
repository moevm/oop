...
void Logger::logFirstGamerWin() {
    proxyLogger.logMessage("Game Over ! First gamer win");
}

void Logger::logSecondGamerWin() {
    proxyLogger.logMessage("Game Over ! Second gamer win");
}
