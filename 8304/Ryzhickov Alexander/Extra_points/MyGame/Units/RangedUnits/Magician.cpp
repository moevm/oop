...
#include "Magician.h"
namespace GameUnit {
    Magician::Magician(int startX, int startY, Weapon *unitWeapon, Armor *unitArmor) : RangedUnit(startX, startY,
                                                                                                  unitWeapon,
                                                                                                  unitArmor) {
    ...
    Magician::Magician(int startX, int startY, Weapon *unitWeapon, Armor *unitArmor, int numberInArray, int health,
