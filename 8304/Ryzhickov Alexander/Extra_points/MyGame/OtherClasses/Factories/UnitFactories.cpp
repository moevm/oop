...
namespace MyGame {
    ...
    Knight *
    UnitFactory::loadKnight(int x, int y, int numberInArray, int health, int armor, int damage, int attackBonus) {
    ...
    Archer *
    UnitFactory::loadArcher(int x, int y, int numberInArray, int health, int armor, int damage, int attackBonus) {
