...
//    std::cout << "dfsd\n";
    ...
    void Base::loadSworsmen(int startX, int startY, int numberInArray, int health,
        ...
        addUnit(startX, startY,
                factory->loadSwordsmen(startX, startY, numberInArray, health, armor, damage, attackBonus));
    }

    void Base::loadSpearmen(int startX, int startY, int numberInArray, int health,
                            int armor, int damage, int attackBonus) {
        addUnit(startX, startY,
                factory->loadSpearmen(startX, startY, numberInArray, health, armor, damage, attackBonus));
    }
    ...
    void Base::loadMagician(int startX, int startY, int numberInArray, int health,
                            int armor, int damage, int attackBonus) {
        addUnit(startX, startY,
                factory->loadMagician(startX, startY, numberInArray, health, armor, damage, attackBonus));
    }
