...
namespace MyGame {
    ...
    public:
        ...
        void
        loadSworsmen(int startX, int startY, int numberInArray, int health, int armor, int damage, int attackBonus);

        void
        loadSpearmen(int startX, int startY, int numberInArray, int health, int armor, int damage, int attackBonus);

        void loadArcher(int startX, int startY, int numberInArray, int health, int armor, int damage, int attackBonus);

        void
        loadMagician(int startX, int startY, int numberInArray, int health, int armor, int damage, int attackBonus);
