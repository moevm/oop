...
constexpr size_t AX_ATTACK_DISTANCE  = 2;
constexpr size_t BOW_ATTACK_DISTANCE = 1;
constexpr size_t FIRE_BALL_ATTACK_DISTANCE  = 2;
constexpr size_t CLAWS_ATTACK_DISTANCE = 2;
constexpr size_t NO_ATTACK_DISTANCE = 0;

constexpr size_t FIRE_BALL_DAMAGE = 1;
constexpr size_t SWORD_DAMAGE  = 1;
