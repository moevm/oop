...
{
	float x = this->p1.x + this->p2.x + this->p3.x + this->p4.x + this->p5.x;
	float y = this->p1.y + this->p2.y + this->p3.y + this->p4.y + this->p5.y;
	return Point{ (float)(x / 5.0), (float)(y / 5.0) };
}
