...
public:
    Knight();
    std::string shortName() {return "KNT";}
    FieldItem *itemCopy(){
...
public:
    ...
    Dryad();
    std::string shortName() {return "DRD";}
    FieldItem *itemCopy(){
...
public:
    Dragon();
    std::string shortName() {return "DRN";}
    FieldItem *itemCopy(){
...
public:
    Witch();
    std::string shortName() {return "WCH";}
    FieldItem *itemCopy(){
...
public:
    Chimera();
    std::string shortName() {return "CHR";}
    FieldItem *itemCopy(){
