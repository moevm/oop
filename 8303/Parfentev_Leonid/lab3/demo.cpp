...
demo7()
{
    ...
    auto *b = new Base {new FactoryTable {}};
    map->addBase(b, {3, 3});
...
demo8()
{
    ...
    auto *b1 = new Base {new FactoryTable {}};
    map->addBase(b1, {3, 3});
    ...
    auto *b2 = new Base {new FactoryTable {}};
    map->addBase(b2, {7, 3});
...
demo9()
{
    ...
    Base *b1 = new Base {new FactoryTable {}};
    map->addBase(b1, {3, 3});
    int b1_id = g.addBase(b1);

    Base *b2 = new Base {new FactoryTable {}};
    map->addBase(b2, {7, 3});
    int b2_id = g.addBase(b2);
