...
{
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with River\n";
...
{
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with Forest\n";
...
{	
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with Swamp\n";
...
{
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with Trap\n";
	if (unit->getClass() == "Infantry")
	{
...
{
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with Gold\n";
	if (unit->getClass() == "Infantry")
	{
		it = new Interactor(new Infantry_Iteraction);
		it->interact(unit);
...
{
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with Rune\n";
	if (unit->getClass() == "Infantry")
	{
		it = new Interactor(new Infantry_Iteraction);
		it->interact(unit);
...
{
	cout << "Unit" + to_string(unit->getSerialNumber()) + ": interact with Curse\n";
	if (unit->getClass() == "Infantry")
	{
		it = new Interactor(new Infantry_Iteraction);
		it->interact(unit);
