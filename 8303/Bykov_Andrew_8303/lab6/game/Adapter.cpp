...
void Adapter::failAttack_Unit_distance(Unit * unit) {
	print("Unit " + to_string(unit->getSerialNumber()) + ": fail to attack. Target is out of range", writeAble, fileWriteAble);
}
void Adapter::failAttack_Unit_disable(Unit * unit) {
	print("Unit " + to_string(unit->getSerialNumber()) + ": fail to attack. Attack is disabled", writeAble, fileWriteAble);
}
void Adapter::failAttack_Unit_no_target(Unit * unit) {
	print("Unit " + to_string(unit->getSerialNumber()) + ": fail to attack. There is no target", writeAble, fileWriteAble);
}
...
void Adapter::noUnit()
{
	print("Fail command. There are no units", writeAble, fileWriteAble);
}
...
void Adapter::step(int player)
{
	print("Player " + to_string(player) + " step", writeAble, fileWriteAble);
}
void Adapter::lose(int player)
{
	print("Player " + to_string(player) + " lose", writeAble, fileWriteAble);
}
void Adapter::restart(string mod)
{
	print("New game started. Game mode - " + mod, writeAble, fileWriteAble);
}