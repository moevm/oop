...
#include <iostream>
#include "Field.h"
Field::Field(int x, int y, Adapter* adapter1) :X(x), Y(y), matrix(new Cell*[X]), objectsCounter(0), maxObjectsOnField(x*y), adapter(adapter1){
...
Field::Field(const Field& obj) : Field(obj.X,obj.Y, obj.adapter)
{
